...
const Header = () => (
    ...
    <header className="govuk-header " role="banner" data-module="govuk-header">
                ...
                <Link to="/" className="govuk-header__link govuk-header__link--homepage">
                    <span className="govuk-header__logotype">
                        <svg aria-hidden="true" focusable="false" className="govuk-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 132 97" height="30" width="36">
                            ...
                            <image src="/assets/images/govuk-logotype-crown.png" display="none" className="govuk-header__logotype-crown-fallback-image" width="36" height="32"/>
                        </svg>
        ...
        <div className="govuk-header__content">
            ...
            <button type="button" className="govuk-header__menu-button govuk-js-header-toggle" aria-controls="navigation" aria-label="Show or hide navigation menu">Menu</button>
            <nav>
